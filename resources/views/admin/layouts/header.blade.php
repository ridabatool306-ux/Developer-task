            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
                ...
                <ul class="navbar-nav navbar-right">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item"> <span
                                        class="dropdown-item-avatar
                                            ...
                                            src="{{ url('admin/assets/img/users/user-1.png') }}" class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image" src="{{ url('admin/assets/img/users/user-3.png') }}"
                                            class="rounded-circle">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            @if(Auth::check())
                            <img alt="image"
                                src="{{asset('storage/' . Auth::user()->image)}}" class="user-img-radious-style">
                                @endif
                                <span
